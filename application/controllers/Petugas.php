...
class Petugas extends CI_Controller
{
	...
	public function index()
    {
        ...
        if ($this->session->userdata('Login')) {
            // Check Hak Akses Admin

            $data['content'] = 'beranda'; 
            
            $this->load->view('petugas/welcome_message', $data);
        } else {
    ...
    public function pelanggan()
    {
        ...
        // Mengakses data dari model
            ...
            $data['content'] = 'petugas/VPelanggan';
            $this->load->view('petugas/welcome_message', $data);
        } else {
        redirect(site_url('Login'));
        } 
    ...
    public function penjualan()
    {
        if ($this->session->userdata('Login')) {
           ...
           $data['content'] = 'petugas/VPenjualan';
           $this->load->view('petugas/welcome_message', $data);
        } else {
            redirect(site_url('Login'));
        }
    ...
    public function tambah_ke_penjualan()
    {
        ...
        redirect(site_url('Petugas/penjualan'));
    }
    ...
    public function detailPenjualan()
    {
        if ($this->session->userdata('Login')) {
            ...
            $data['DataProduk'] = $this->MSudi->GetData('produk');
            $data['DataPenjualan'] = $this->MSudi->GetData('penjualan');
            $data['content'] = 'petugas/VDPenjualan';
            $this->load->view('petugas/welcome_message', $data);
        } else {
            redirect(site_url('Login'));
        }
