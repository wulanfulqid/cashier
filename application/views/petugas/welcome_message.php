                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item <?php echo ($this->uri->segment(2) == 'VPelanggan') ? 'active' : ''; ?>"
                            href="<?php echo site_url('Petugas/pelanggan') ?>">Pelanggan</a>
			...
			<li class="nav-item">
                ...
                <div id="collapseThree" class="collapse show" aria-labelledby="headingThree"
					...
					<a class="collapse-item <?php echo ($this->uri->segment(2) == 'VPenjualan') ? 'active' : ''; ?>"
                            href="<?php echo site_url('Petugas/penjualan') ?>">Penjualan</a>
							<a class="collapse-item <?php echo ($this->uri->segment(2) == 'VDPenjualan') ? 'active' : ''; ?>"
                            href="<?php echo site_url('Petugas/detailPenjualan') ?>">Detail Penjualan</a>
                </div>
            </li>
                ...
                <div id="collapseFour" class="collapse show" aria-labelledby="headingFour"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
					   <a class="collapse-item <?php echo ($this->uri->segment(2) == 'VProduk') ? 'active' : ''; ?>"
                            href="<?php echo site_url('Petugas/produk') ?>">Produk</a>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid ">
                    ...
                    <!-- Include the Petugas Message Here -->
